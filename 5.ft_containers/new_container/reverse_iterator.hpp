...
// reverese_iterator =================================================================
    ...
    class reverse_iterator {
        ...
        public:
                // random access iterator 기반으로 만들어지기 떄문에! Iterator를 받아온다 >> iterator_traits로 확인!
...
// constructor & destructor =================================================================
        ...
        // 암시적 형변환을 안되게!
        // random_access_iterator 만 받아오게 끔! (iterator_type 으로만 만들기위한 생성자?)
...
// arithmetic operators =================================================================
        ...
        // 해당 기능을 vector에서 사용하므로 vector_iterator를 random_access_iterator로 구현한다.
